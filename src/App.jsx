...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://127.0.0.1:8888/api/sales-data');
  ...
  const generateAIInsights = async () => {
    ...
    try {
      ...
      const response = await fetch('http://127.0.0.1:8888/api/ai-insights', {
        method: 'POST',
      ...
      alert("Failed to generate AI insights. Ensure the AI Proxy Server is running.");
    } finally {
      setAiLoading(false);
    }
  };
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex items-center gap-3 bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <button className="flex items-center gap-2 px-5 py-2 bg-primary-600 rounded-lg text-sm font-bold text-white hover:bg-primary-700 transition-all shadow-md shadow-primary-200">
                Generate Report
              </button>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all font-medium"
              />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-slate-400 flex items-center gap-1.5">
            ...
            <div className="space-y-2">
              ...
              <select 
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all font-medium appearance-none"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <InsightCard 
              ...
              icon={<Package size={14} className="text-primary-600" />}
            />
            <InsightCard 
              label="Growth Engine" 
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800 shadow-2xl overflow-hidden text-white">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button 
                  ...
                  className={`px-6 py-2 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${
                    aiLoading ? 'bg-slate-700 text-slate-500 cursor-not-allowed' : 'bg-primary-500 hover:bg-primary-400 text-white shadow-lg shadow-primary-500/30'
                  }`}
                >
            ...
            {aiInsights ? (
              <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  <h4 className="flex items-center gap-2 text-primary-400 font-bold uppercase text-[10px] tracking-[0.2em]">
                    <TrendingUp size={14} /> Opportunities
                  </h4>
                  <ul className="space-y-3">
                    {aiInsights.opportunities.map((o, i) => (
                      <li key={i} className="bg-primary-500/5 border border-primary-500/10 p-3 rounded-xl text-sm font-medium text-primary-200">
                        {o}
                      </li>
                    ))}
                  </ul>
            ...
            {aiLoading && (
              <div className="p-12 flex flex-col items-center gap-4">
                <div className="animate-bounce w-2 h-2 bg-primary-500 rounded-full shadow-[0_0_15px_rgba(14,165,233,0.5)]"></div>
            ...
            <div className="px-8 py-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/30">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-11 pr-5 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all w-full sm:w-80 font-medium shadow-sm"
                />
              </div>
            </div>
...
const InsightCard = ({ label, value, desc, icon }) => (
  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-start gap-3 group hover:border-primary-200 transition-all cursor-default">
